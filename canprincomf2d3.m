...
E=[1 zeros(1,8) 0.9;0 1 zeros(1,6) 0.8 0;0 0 1 zeros(1,4) 0.7 zeros(1,2) ;zeros(1,3) 1 zeros(1,5) 0;zeros(1,4) 1 zeros(1,4) 0;zeros(1,5) 1 zeros(1,4);zeros(1,6) 1 zeros(1,3);0 0 0.7 zeros(1,4) 1 0 0;0 0.8 zeros(1,6) 1 0;0.9 zeros(1,8) 1];
sg=zeros(r,n);
for a=1:length(M);
...
M3=zeros(1,R(b));
M4=zeros(1,R(b));
M5=zeros(1,R(b));%To store the mean of singualr values averaged 1000 times
for i=1:3
M1(1,i)=mean(m1(:,i));
M2(1,i)=mean(m2(:,i));
M3(1,i)=mean(m3(:,i));
